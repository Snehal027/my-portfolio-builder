        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6">
              {education.map((edu) => (
                <div key={edu.degree} className="p-5 rounded-xl bg-background border border-border">
          ...
          <div>
            ...
            <div className="space-y-3">
              {certifications.map((cert) => (
                <div
                  key={cert}
                  className="p-4 rounded-xl bg-background border border-border flex items-center gap-3 hover:border-primary/30 transition-colors"
                >
